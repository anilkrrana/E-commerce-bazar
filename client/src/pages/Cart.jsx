  ...
  return (
    <div>
      <img
        ...
        src="https://www.pexels.com/photo/women-buying-clothes-together-5418899/"
        alt="cartImg"
      />
          ...
          <div className="w-1/3 bg-[#fafafa] py-6 px-4">
            ...
            {payNow && (
              <div className="w-full mt-6 flex items-center justify-center">
                <StripeCheckout
                  stripeKey="pk_test_51NciCySJSfdrzLkiGczHSfZsUNKNleVCr2jWpBGvoTLzphsSbwcHKQgzLNEkHvnxatT9OXDRoKMhu4N8uUN9gO3R0088zJswie"
